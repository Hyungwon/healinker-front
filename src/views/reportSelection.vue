<template>
  <div :class="$style.frameworkPc">
    <div :class="$style.header">
      ...
      <div :class="$style.headerAuth">
        <div :class="$style.avatar">
          <div :class="$style.initials">F</div>
        </div>
        <img :class="$style.chevronDownIcon" alt="" :src="icons.icon_chevron_down"/>
      </div>
    </div>
    <div :class="$style.heroActions">
      ...
      <div :class="$style.statsCard">
        <div :class="$style.button">
          <img :class="$style.chevronDownIcon" alt="" :src="icons.icon_file"/>
    ...
    <div :class="$style.footer">
      ...
      <div :class="$style.textLinkListItem">
        <div :class="$style.div">힐링커 | 사업자등록번호: 000-00-00000 | 통신판매번호 2021-서울구로-0459 | 대표자: 000 | 주소: 서울시 영등포구 은행로 11,
          2층 | 대표전화: 1666-2837
        </div>
